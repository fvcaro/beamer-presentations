...
\end{frame}
%================================================================================================================
\begin{frame}{A Painless $hp$-Adaptive Strategy for Non-Parametric PDEs}
...
\begin{block}{Objective}
	To control the relative error the \tcr{Quantity of Interest} (QoI), ensuring that it falls within a specified tolerance $TOL$:
	\begin{equation}
...
\end{frame}
%================================================================================================================
\begin{frame}{MAGO: Validating the Adaptive Meshes with 1K Samples}
