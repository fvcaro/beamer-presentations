...
\textbf{\tcr{Competitive} in all the tested problems}
...
\begin{enumerate}
  ...
  \item \tcr{Light implementation}: we operate \textbf{only with a single mesh}.
...
\end{frame}
%================================================================================================================
\section{Extension to Parametric PDEs: One Grid for all Model Parameteres}
%================================================================================================================
\begin{frame}
    \frametitle{Outline}
    \tableofcontents[currentsection]
...
%================================================================================================================
\begin{frame}
	\frametitle{One Grid to Rule Them All}
	
	\vspace{-1mm}
	\begin{block}{Definitions}
	\begin{itemize}
	
	\item   $\m_1 = \{\sig_1, \ldots, \sig_N \}$ set of model parameters that parametrize one problem.
	 \item  $S$ possibly different samples of parameters:  $\m= \{\m_1, \ldots , \m_S \}$
	\end{itemize}
...
\begin{block}{Proposed Solution: One Grid to Rule Them All}
	    \textbf{Objective}: To build a \tcr{\underline{\textbf{single}} $hp$-mesh} that provides \tcr{accurate solutions for all $\m$ at once}.
	  \end{block}

\note[Moreover, due to the singularities or discontinuities in the deriva- tives along with material interfaces that the solutions may exhibit, these problems often demand rather fine or complex finite element grids to accurately describe them \\ enormous number of problems that DNNs employ for approximating the inverse operator in the training process, it becomes necessary to design efficient numerical methods that maintain the computational cost under control.]
...
\begin{itemize}
	...
	\begin{itemize}
		\item Precompute integrals of stiffness matrix and right-hand sides.
...
\begin{frame}{MAGO: Time to Generate Databases of 100K Samples}
	\boxplotmagoTime[Results/boxplot]{_100k}{mat_adapt_1}{mat_adapt_5}{mat_adapt_100}
\end{frame}
%================================================================================================================
