...
%
%\getelemdbl{\DataPath/outputs.txt}{MaxEstim}{\index}{\MaxEstim}

%\getelem{\DataPath/outputs.txt}{nr_dof}{#2}{\nrdof}
%\getelemdbl{\DataPath/outputs.txt}{Error}{#2}{\error}
%
%\getelemdbl{\DataPath/outputs.txt}{MaxEstim}{#2}{\MaxEstim}
% use the following to display nicely the estimator value
%\pgfmathprintnumber[std, precision=2]{\MaxEstim}
\only<+>{f
\begin{figure}
\centering
...
%      ymin=1e-2,
%      ymax=1e1,
      xlabel={Number of \textbf{testing} samples},
...
% \renewcommand{\DataPath}{#1/#6/Check/mat_check}
%  \pgfplotstableread[header=false]{\DataPath/QoI_error_boxplot.csv}{\mytable}
%
% \pgfplotstablegetelem{0}{[index]0}\of{\mytable}
%\pgfmathsetmacro\lowwiskercin{\pgfplotsretval}
...
\subcaption{ Evolution of relative error}
\end{subfigure}
...
%:\captionifthen
\newcommand{\captionifthen}[1]{%
\ifthenelse{\equal{#1}{lap2D}}{Regular GOA}{%
\ifthenelse{\equal{#1}{CrossGOA}}{Singular Poisson GOA}{%
\ifthenelse{\equal{#1}{DiffConv2D}}{Boundary Layer}{%
\ifthenelse{\equal{#1}{Helm2DGOANon}}{Singular wave propagation}{%
\ifthenelse{\equal{#1}{DiffConv2DGOA}}{Boundary Layer GOA}{%
\ifthenelse{\equal{#1}{Helm2DGOA}}{Singular wave propagation}{%
\ifthenelse{\equal{#1}{maxwellGOA}}{Maxwell GOA}{%
\ifthenelse{\equal{#1}{sinsin2D}}{Regular}{%
\ifthenelse{\equal{#1}{singularsquare2D}}{Singular}{%
\ifthenelse{\equal{#1}{sin2D}}{Regular one dimensional}{%
\ifthenelse{\equal{#1}{singular2D}}{Singular one dimensional}{%
\ifthenelse{\equal{#1}{atan2D}}{Shock one dimensional}{%
\ifthenelse{\equal{#1}{atancircle2D}}{Shock}{prout!}%
}}}}}}}}}}}}%
}

\newcommand{\captionifthenlegend}[1]{%
\ifthenelse{\equal{#1}{lap2D}}{$H^1$ semi-norm}{%
\ifthenelse{\equal{#1}{lap2DLshape}}{$H^1$ semi-norm}{%
\ifthenelse{\equal{#1}{DiffConv2D}}{the QoI}{%
\ifthenelse{\equal{#1}{Helm2DGOA}}{the QoI}{%
\ifthenelse{\equal{#1}{CrossGOA}}{the QoI}{%
\ifthenelse{\equal{#1}{DiffConv2DGOA}}{the QoI}{%
\ifthenelse{\equal{#1}{Helm2DGOANon}}{the energy-norm}{%
\ifthenelse{\equal{#1}{maxwellGOA}}{the QoI}{%
\ifthenelse{\equal{#1}{sinsin2D}}{$H^1$ semi-norm}{%
\ifthenelse{\equal{#1}{singularsquare2D}}{$H^1$ semi-norm}{%
\ifthenelse{\equal{#1}{sin2D}}{$H^1$ semi-norm}{%
...
%:\plotmeshgif
\newcommand{\plotmeshgif}[3]{%
\renewcommand{\DataPath}{\FigurePath/#1/hp/p2/unref_0.1/unref_h_0.3}
\findmax{\DataPath/outputs.txt}{iter}{\endIter}
\pgfmathparse{subtract(\endIter,-1)} 
\pgfmathtruncatemacro\index{\pgfmathresult}
%
%
\begin{subfigure}{\subplotwidth}
	\plothpDmeshGIF{#1/hp/p2/unref_0.1/unref_h_0.3}{#2}{\index}{#3}
\end{subfigure}%
}
...
\pgfplotscreateplotcyclelist{custom list style}{%
  ...
  color=blue, solid, every mark/.append style={solid}, mark=triangle*\\%
  %color=black!50!green,dotted, every mark/.append style={solid}, mark=square*\\%
  color=black!50!green,solid, every mark/.append style={solid}, mark=square*\\%
  color=black, solid, every mark/.append style={solid},mark=diamond*\\%dashed
  color=black!50!red, solid, every mark/.append style={solid}, mark=otimes*\\%densely dotted
  color=black!50!yellow, solid, every mark/.append style={solid},mark=*\\%loosely dashed
