...
\pgfplotscreateplotcyclelist{custom list style}{%
  ...
  color=blue, loosely dotted, every mark/.append style={solid}, dashed,mark size=3.0pt,mark=square\\%
  color=gray!20!black!40, densely dashed, every mark/.append style={solid}, mark size=2.5pt, mark=triangle\\%
