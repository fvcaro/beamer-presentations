% !TEX root =../beamer-presentation.tex
...
\newcommand*{\goasolutions}[3][]{%
 ...
 %
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \directadjointsolution{#2/hp/order_1}{\endIterformated}{Direct_solution_#3}{Direct}{#1}%
  ...
  \begin{subfigure}[t]{0.45\textwidth}
   \centering
   \directadjointsolution{#2/hp/order_1}{\endIterformated}{Adjoint_solution_#3}{Adjoint}{#1}%
